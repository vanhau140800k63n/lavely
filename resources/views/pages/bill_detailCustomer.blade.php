                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="payment_input">
                                    <h5 class="mb-2"><b>Họ và tên:</b> {{$customer->name}}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="payment_input">
                            <h5 class="mb-2"><b>Địa chỉ: </b>{{$customer->address}}</h5>

                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="payment_input">
                                    <h5 class="mb-2"><b>Số điện thoại: </b>{{$customer->phone_number}}</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="payment_input">
                                    <h5><b>Hình thức thanh toán:</b>  {{$bill->payment}}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="payment_input">
                                    <h5><b>Tổng thanh toán: </b>{{number_format($bill->total)}} <u>đ</u></h5>
                                </div>
                            </div>
                        </div>
                        <div>
